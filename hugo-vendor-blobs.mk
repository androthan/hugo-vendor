...
# Extra apps
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,vendor/samsung/hugo/proprietary/apps,system/app)   

#DSP
PRODUCT_COPY_FILES += \
	$(call find-copy-subdir-files,*,vendor/samsung/hugo/proprietary/baseimage/lib/dsp,system/lib/dsp)

# bluetooth
PRODUCT_COPY_FILES += \
    vendor/samsung/hugo/proprietary/bluetooth/lib/firmware/TIInit_7.2.31.bts:root/lib/firmware/TIInit_7.2.31.bts
...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/hugo/proprietary/omx/libOMX.ITTIAM.AAC.decode.so:system/lib/libOMX.ITTIAM.AAC.decode.so \
    vendor/samsung/hugo/proprietary/omx/libOMX.ITTIAM.AAC.encode.so:system/lib/libOMX.ITTIAM.AAC.encode.so \
